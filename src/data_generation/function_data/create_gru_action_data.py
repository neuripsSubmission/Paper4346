...
def get_scenes(scenes, scanName):
    if dataset == "mp3d":
        scene = "{}{}/{}.glb".format(sim_dir, scanName, scanName)
    else:
        scene = "{}{}.glb".format(sim_dir, scanName)
...
if __name__ == "__main__":
    dataset = "mp3d"  # "gibson"
    sim_dir = "/srv/share/datasets/habitat-sim-datasets/"
    if dataset == "mp3d":
        sim_dir += "mp3d/"
    else:
    ...
    action_dir = base_dir + "behavioral_cloning/"
    ...
    print(len(passive_scenes))
    houseList = sorted(passive_scenes)[5:15]
