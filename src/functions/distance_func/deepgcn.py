...
from src.functions.distance_func.layers import AttentionConv, CGConv
...
class TopoGCN(nn.Module):
    def __init__(self, input_size=512, hidden_size=256, edge_size=16):
        ...
        #     Lin(hidden_size + input_size, input_size),  # 128
        #     ReLU(True),
        #     Lin(input_size, 1),  # 128
        # )
        """v2"""
