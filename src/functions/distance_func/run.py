...
from src.functions.distance_func.deepgcn import XRN
from src.functions.distance_func.batch_traj_loader import Loader
from src.utils.cfg import input_paths

# Training settings
parser = argparse.ArgumentParser()
parser = input_paths(parser)
parser.add_argument("--run_name", type=str, default="deepgcn_CGConv")
