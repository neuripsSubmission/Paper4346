...
class Loader:
    ...
    # def true_node_to_point(self, index, valid_point, goal_index, data_obj):
    ...
    def build_dataset(self, split):
        ...
        splitScans = [x.strip() for x in open(splitFile2, "r").readlines()]
        clustered_graph_dir = "/srv/flash1/mhahn30/topo_nav/gibson/clustered_graph/"
        for house in splitScans:
            houseFile = clustered_graph_dir + house + "_graphs.msg"
            data.append(msgpack_numpy.unpack(open(houseFile, "rb"), raw=False))
