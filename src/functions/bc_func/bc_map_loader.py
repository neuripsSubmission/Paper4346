...
class Loader:
    def __init__(self, args):
        ...
        if self.args.dataset == "mp3d":
            self.sim_dir += "mp3d/"
            self.map_dir = "/srv/flash1/mhahn30/topo_nav/mp3d/bc_metric_maps/"

        else:
            self.sim_dir += "gibson_train_val/"
            self.map_dir = "/srv/flash1/mhahn30/topo_nav/gibson/bc_metric_maps/"
